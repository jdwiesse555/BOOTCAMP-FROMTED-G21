...
let  numtres = 123
let numero1 = numtres%10
numtres = Math.trunc(numtres/ 10)
let numero2 = numtres%10
numtres = Math.trunc(numtres/ 10)
let numero3 = numtres%10
numtres = Math.trunc(numtres/ 10)
console.log("suma ** 2 : ", (numero2+numero1+numero3)**2)
 numtres = 123
console.log("A 30% de "+ numtres+": ", numtres*.3)
console.log("B 20% de "+ numtres+": ", numtres*.2)
console.log("C 60% de "+ numtres+": ", numtres*.6)

let j1=0
const idioma = "ingles1"
...
if (var1%3==0 && var1%5==0) {
    ...
    for(let i=2;i<var2;i++){
        if (var2%i==0 && var2!=i) resul=false
    }
    console.log("el numero  "+var2+" es primo:",resul) 
